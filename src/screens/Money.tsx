    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerTop}>
          ...
          <View style={styles.rightSection}>
            ...
            <View style={{ alignItems: "flex-end" }}>
              <Text style={styles.balance}>฿{todayIncome}</Text>
        ...
        <View style={styles.statsRow}>
          <StatBox number={todayOrders} label="ออเดอร์วันนี้" />
          <StatBox number={totalOrders} label="ออเดอร์ทั้งหมด" />
          <StatBox number={avgScore.toFixed(1)} label="คะแนนเฉลี่ย" />
        </View>
      </View>
